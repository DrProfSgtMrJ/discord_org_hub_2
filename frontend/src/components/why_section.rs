...
const WHY_CARDS: &[WhyCard] = &[WhyCard {
    ...
    images: &[
        asset!("/assets/bot_seasons_example.png"),
        asset!("/assets/bot_season_info_example.png"),
    ],
    back_title: "Commands",
...
pub fn AnimatedWhyCard(card: &'static WhyCard) -> Element {
    ...
    rsx! {
        div { class: "why-item",
            // animated card (left)
            div { class: "why-card why-card-animated", onclick: handle_click,
                div {
